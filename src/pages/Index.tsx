...
import { Helmet } from "react-helmet"; // ✅ React Helmet for meta description
...
const Index = () => {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>Smart Expense Tracker | Manage Your Daily Expenses</title>
        <meta
          name="description"
          content="Track and manage your daily expenses with Smart Expense Tracker. Visualize your spending, control your budget, and improve your financial habits easily."
        />
      </Helmet>
      ...
      <div className="min-h-screen bg-background grid-pattern">
        ...
        >
          <div className="px-6 lg:px-8 py-4 flex items-center gap-3">
            ...
            >
              Smart Expense Tracker - Manage Your Daily Expenses Easily
            </h1>
          </div>
        </motion.header>
        ...
        <div className="lg:flex">
          ...
          <main className="lg:w-[62%] border-t lg:border-t-0 border-border/50">
            {/* ✅ H2 for section */}
            <h2 className="text-lg font-semibold mt-4 mb-2">Expense Ledger</h2>
            <FilterBar
